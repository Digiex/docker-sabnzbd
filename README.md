# [digiex/sabnzbd](https://github.com/digiex/docker-sabnzbd)
...
Simply pulling `digiex/sabnzbd` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
* Update the image: `docker pull digiex/sabnzbd`
